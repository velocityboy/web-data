...
export class HttpRequestParametersDialog {
  ...
  constructor(container) {
    ...
    this.addFormDataEditor(container);
  ...
  addValidatingEditor(container, fieldName, warningText, defaultValue, onChange) {
  ...
  addFormDataEditor(container) {
    this.formDataDiv = this.addValidatingEditor(
      container,
      'Form Data',
